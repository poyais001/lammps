...
double GTNDamageIncrement(const double Q1, const double Q2, const double An, const double Komega, const double pressure, 
                          const Eigen::Matrix3d Sdev, const Eigen::Matrix3d stress, const double eff_plastic_strain, const double plastic_strain_increment, 
                          const double damage, const Eigen::Matrix3d Fdot, const double yieldstress, const double hM);
